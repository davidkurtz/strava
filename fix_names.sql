...
Alter table my_areas2 add suffix varchar2(20);

Select distinct area_code, SUBSTR(name,1,LENGTH(name)-7) name
from my_areas2 Where 
name like '%County'
/
Update my_areas2
...
from my_areas2 Where name like '%Authority'
/
Update my_areas2
...
from my_areas2 Where name like '%District'
/
Update my_areas2
...
/
----------
Select distinct area_code, name, suffix from my_areas2 
/
...
/
----------
Select distinct suffix from my_areas2
/
Select distinct area_code, area_level, suffix from my_areas2
order by 2,1
/
...
/
----------
Alter table my_areas2 modify suffix null;
Select distinct area_code, suffix from my_areas2 
/
