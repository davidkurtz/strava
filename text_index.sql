...
/*
UPDATE my_areas
SET name_heirarchy = strava_pkg.name_heirarchy_fn(parent_area_code,parent_area_number)
...
----------------------------------------------------------------------------------------------------
--search for highest matching area in heirarchy
----------------------------------------------------------------------------------------------------
column area_Code heading 'Area|Code'
column area_number heading 'Area|Number' 
column name format a25
column name_heirarchy format a60
