REM Switzerland_load_country2.sql
...
DECLARE 
  l_url VARCHAR2(1000)
  := 'https://labs.karavia.ch/swiss-boundaries-geojson/geojson/2020/swissBOUNDARIES3D_1_3_TLM_LANDESGEBIET.geojson';
...
, area_number = 1159320491
, uqid = 'NE1159320491'
where name = 'Schweiz'
/

UPDATE stage_my_areas
set area_number = 1159321021
, uqid = 'NE1159321021'
where name = 'Liechtenstein'
/

delete from stage_my_areas
where area_number IN(76502,76503)
/

select a.*,SDO_GEOM.SDO_AREA(geom, 0.001,'unit=sq_km')
from my_areas a
where name IN('Switzerland','Liechtenstein')
/
...
--manually fix martina activity
UPDATE activities
SET processing_status = 3
where activity_id = 11644391830 /*Martina*/
/
INSERT INTO activity_areas
VALUES (11644391830,'SOVC',1159320491, NULL);

clear screen
set serveroutput on 
exec strava_sdo.activity_area_hsearch(11644391830,'SOVC',1159320491);
